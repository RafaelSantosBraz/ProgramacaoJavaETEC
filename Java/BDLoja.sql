...
/*Table structure for table `email_cliente_fisica` */

DROP TABLE IF EXISTS `email_cliente_fisica`;

CREATE TABLE `email_cliente_fisica` (
  `Cod_Email_Cliente_Fisica` int(4) NOT NULL AUTO_INCREMENT,
  `Cod_Cliente_Fisica` int(4) NOT NULL,
  `Email_Cliente_Fisica` varchar(50) NOT NULL,
  PRIMARY KEY (`Cod_Email_Cliente_Fisica`),
  KEY `Email_Cliente_Fisica_FKIndex1` (`Cod_Cliente_Fisica`),
  CONSTRAINT `FK_email_cliente_fisica` FOREIGN KEY (`Cod_Cliente_Fisica`) REFERENCES `cliente_fisica` (`Cod_Cliente_Fisica`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `email_cliente_fisica` */

/*Table structure for table `email_cliente_juridica` */

DROP TABLE IF EXISTS `email_cliente_juridica`;

CREATE TABLE `email_cliente_juridica` (
  `Cod_Email_Cliente_Juridica` int(4) NOT NULL AUTO_INCREMENT,
  `Cod_Cliente_Juridica` int(4) NOT NULL,
  `Email_Cliente_Juridica` varchar(50) NOT NULL,
  PRIMARY KEY (`Cod_Email_Cliente_Juridica`),
  KEY `Email_Cliente_Juridica_FKIndex1` (`Cod_Cliente_Juridica`),
  CONSTRAINT `FK_email_cliente_juridica` FOREIGN KEY (`Cod_Cliente_Juridica`) REFERENCES `cliente_juridica` (`Cod_Cliente_Juridica`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `email_cliente_juridica` */
...
CREATE TABLE `email_fornecedor` (
  `Cod_Email_Fornecedor` int(4) NOT NULL AUTO_INCREMENT,
  `Cod_Fornecedor` int(4) NOT NULL,
  `Email_Fornecedor` varchar(50) NOT NULL,
  PRIMARY KEY (`Cod_Email_Fornecedor`),
  KEY `Email_Fornecedor_FKIndex1` (`Cod_Fornecedor`),
  CONSTRAINT `FK_email_fornecedor` FOREIGN KEY (`Cod_Fornecedor`) REFERENCES `fornecedor` (`Cod_Fornecedor`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `email_fornecedor` */
...
/*Table structure for table `telefone_cliente_fisica` */

DROP TABLE IF EXISTS `telefone_cliente_fisica`;

CREATE TABLE `telefone_cliente_fisica` (
  `Cod_Telefone_Cliente_Fisica` int(4) NOT NULL AUTO_INCREMENT,
  `Cod_Cliente_Fisica` int(4) NOT NULL,
  ...
  PRIMARY KEY (`Cod_Telefone_Cliente_Fisica`),
  KEY `Telefone_Cliente_Fisica_FKIndex1` (`Cod_Cliente_Fisica`),
  CONSTRAINT `FK_telefone_cliente_fisica` FOREIGN KEY (`Cod_Cliente_Fisica`) REFERENCES `cliente_fisica` (`Cod_Cliente_Fisica`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `telefone_cliente_fisica` */

/*Table structure for table `telefone_cliente_juridica` */

DROP TABLE IF EXISTS `telefone_cliente_juridica`;

CREATE TABLE `telefone_cliente_juridica` (
  `Cod_Telefone_Cliente_Juridica` int(4) NOT NULL AUTO_INCREMENT,
  `Cod_Cliente_Juridica` int(4) NOT NULL,
  ...
  PRIMARY KEY (`Cod_Telefone_Cliente_Juridica`),
  KEY `Telefone_Cliente_Juridica_FKIndex1` (`Cod_Cliente_Juridica`),
  CONSTRAINT `FK_telefone_cliente_juridica` FOREIGN KEY (`Cod_Cliente_Juridica`) REFERENCES `cliente_juridica` (`Cod_Cliente_Juridica`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `telefone_cliente_juridica` */
...
CREATE TABLE `telefone_fornecedor` (
  `Cod_Telefone_Fornecedor` int(4) NOT NULL AUTO_INCREMENT,
  `Cod_Fornecedor` int(4) NOT NULL,
  ...
  KEY `Telefone_Fornecedor_FKIndex1` (`Cod_Fornecedor`),
  CONSTRAINT `FK_telefone_fornecedor` FOREIGN KEY (`Cod_Fornecedor`) REFERENCES `fornecedor` (`Cod_Fornecedor`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `telefone_fornecedor` */
